      ...
      <section className="relative py-[100px] max-lg:py-[70px] max-sm:py-[50px]">
        <div className="container mx-auto">
          <div className="grid grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-6 max-lg:gap-4">
            {blogs.map((blog) => {
                return (
                  <div key={blog.id} className="shadow-md rounded-lg cursor-pointer" onClick={() => router.push(`/blogs/${blog.id}`)}>
                    <div>
                      <Image
                        ...
                        width={300}
                        height={200}
                        className=" w-full h-[250px] object-cover rounded-t-lg max-sm:h-[200px]"
                      />
                    </div>
